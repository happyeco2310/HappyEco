...
HappyEco is an application that encourages people to recycle more goods as mankind is continuing to generate vast volumes of garbage that can easily be recycled. But instead of recycling it, we are just dumping it in the open.
...
# Features
This app gives some locations of recycle plants in the city of the user. It also provides pick and drop service which may be more comfortable for the user.
